...
% Simulate the COMSOL model with different seperation
...
tic;
model.param.set('tint', [num2str(400) ' [nm']);
model.param.set('tint_up', [num2str(200) ' [nm']);
...
model.result.export('img1').set('pngfilename', ['SDSautomationNo1changeSubsDistance\PML\' 'real\real(u_tZ) @' num2str(freq_acous) 'GHz']);
model.result.export('img2').set('sourceobject', 'pg3');
model.result.export('img2').set('pngfilename', ['SDSautomationNo1changeSubsDistance\PML\' 'imag\imag(u_tZ)@' num2str(freq_acous) 'GHz']);
