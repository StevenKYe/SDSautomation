function newModel = configParas(model, tg, tint, tc, w)
    ...
    model.param('par2').set('t_g1', [num2str(tg) ' [nm]']);
    model.param('par2').set('t_g2', [num2str(tg) ' [nm]']);
    model.param('par2').set('t_int', [num2str(tint) ' [nm]']);
    model.param('par2').set('w', [num2str(w) ' [nm]']);
    model.param('par2').set('t_c', [num2str(tc) ' [um]']);
    ...
    model.param('par2').set('t_intup', [num2str(tg + tint) ' [nm]']);
