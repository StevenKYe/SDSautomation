...
% nlnp2021stevenSDS.m
%
% Model exported on Oct 18 2021, 12:13 by COMSOL 5.6.0.280.
...
model.modelPath('C:\Users\YeK\OneDrive - University of Twente\working\siliconNitrideSimulation(O)\SDSautomation(matlab)');

model.label('nlnp2021stevenSDS(formatlab).mph');

model.param.set('lambda_pump', '1550 [nm]');
model.param.set('freq_pump', 'c_const/lambda_pump');
model.param.set('freq_acous', '13.585 [GHz]');
...
model.param('par2').set('w', '2800 [nm]', 'waveguide width');
...
model.param('par2').set('t_intup', '225 [nm]');
...
model.component('comp2').geom('geom2').feature('r2').set('size', {'w_model' 't_b'});
...
model.component('comp2').geom('geom2').feature('r8').set('pos', {'-0.5 * w_model' '-4 * (t_int + t_g1 + t_g2)'});
...
model.component('comp1').variable('var9').selection.set([2 3 4 5]);
...
model.component('comp2').variable('var14').selection.set([6 7 8 9 10 11]);
...
model.component('comp2').variable('var15').selection.set([6 7 8 9 10 11]);
...
model.component('comp2').variable('var17').set('overlap', 'intall(overlap_x + overlap_y + overlap_z)');
...
model.component('comp2').material('mat4').selection.set([10 11]);
model.component('comp2').material('mat5').selection.set([3 6 7 8 9 14]);
model.component('comp2').material('matlnk1').selection.set([1 2 4 5 12 13]);
...
model.component('comp2').cpl('intop3').selection.set([7 8 10 11]);
model.component('comp1').cpl('maxop1').selection.set([2 3 4 5]);
model.component('comp2').cpl('maxop2').selection.set([7 8 10 11]);

model.component('comp2').coordSystem.create('pml1', 'PML');
model.component('comp2').coordSystem('pml1').selection.set([1 2 3 4 12 13 14]);
...
model.component('comp2').physics('solid').feature('lemm1').feature('exs1').selection.set([6 7 8 9 10 11]);
...
model.component('comp2').physics('solid').feature('lemm2').selection.set([1 2 4 5 12 13]);

model.component('comp1').mesh('mesh1').create('ftri1', 'FreeTri');
model.component('comp1').mesh('mesh1').feature('ftri1').selection.geom('geom1', 2);
model.component('comp1').mesh('mesh1').feature('ftri1').selection.set([1 2 3 4 5]);
model.component('comp1').mesh('mesh1').feature('ftri1').create('size1', 'Size');
model.component('comp1').mesh('mesh1').feature('ftri1').create('size2', 'Size');
model.component('comp1').mesh('mesh1').feature('ftri1').feature('size1').selection.set([4 5]);
model.component('comp1').mesh('mesh1').feature('ftri1').feature('size2').selection.set([1 2 3]);
...
model.component('comp2').mesh('mesh2').feature('map1').selection.set([1 2 3 4 12 13 14]);
...
model.component('comp2').mesh('mesh2').feature('ftri1').selection.set([5 6 7 8 9 10 11]);
...
model.component('comp2').mesh('mesh2').feature('ftri1').feature('size1').selection.set([5 6 7 8 9]);
model.component('comp2').mesh('mesh2').feature('ftri1').feature('size2').selection.set([10 11]);
...
model.component('comp1').view('view1').axis.set('xmin', -11660.9375);
model.component('comp1').view('view1').axis.set('xmax', 11660.9375);
model.component('comp1').view('view1').axis.set('ymin', -9876.5625);
model.component('comp1').view('view1').axis.set('ymax', 8876.5625);
model.component('comp2').view('view2').axis.set('xmin', -12346.875);
model.component('comp2').view('view2').axis.set('xmax', 12346.875);
model.component('comp2').view('view2').axis.set('ymin', -10900);
model.component('comp2').view('view2').axis.set('ymax', 8900);
...
model.material('mat7').propertyGroup('RefractiveIndex').set('n', {'3.48' '0' '0' '0' '3.48' '0' '0' '0' '3.48'});
...
model.component('comp1').cpl('linext1').selection('srcvertex1').set([4]);
model.component('comp1').cpl('linext1').selection('srcvertex2').set([16]);
model.component('comp1').cpl('linext1').selection('srcvertex3').set([14]);
model.component('comp1').cpl('linext1').selection('dstvertex1').set([11]);
model.component('comp1').cpl('linext1').selection('dstvertex2').set([26]);
model.component('comp1').cpl('linext1').selection('dstvertex3').set([22]);
model.component('comp2').cpl('intop3').label('Integration (all)');
model.component('comp2').cpl('intop3').set('opname', 'intall');
...
model.result('pg2').feature('surf1').set('expr', 'overlap_z');
...
model.study('std1').feature('mode').set('shift', '1.5871');
...
model.study('std1').feature('mode2').set('modeFreq', 'freq_pump');
...
model.study('std1').feature('mode2').set('shift', '1.5871');
...
model.sol('sol1').feature('e1').set('shift', '1.5871');
...
model.sol('sol1').feature('e2').set('shift', '1.5871');
...
model.result.evaluationGroup('eg2').feature('gev1').set('unit', {''});
...
model.result.evaluationGroup('eg3').feature('gev1').set('expr', {'overlapField' 'SBSgain'});
model.result.evaluationGroup('eg3').feature('gev1').set('unit', {'1' 's^3/(kg*m^3)'});
model.result.evaluationGroup('eg3').feature('gev1').set('descr', {'' ''});
model.result.evaluationGroup('eg3').feature('gev1').set('const', {'solid.refpntx' '0' 'Reference point for moment computation, x coordinate'; 'solid.refpnty' '0' 'Reference point for moment computation, y coordinate'; 'solid.refpntz' '0' 'Reference point for moment computation, z coordinate'});
...
model.result('pg2').feature('surf1').set('unit', 'W/m^3');
...
model.result('pg2').feature('surf1').feature('def').set('scale', 1.8601157462369075E19);
